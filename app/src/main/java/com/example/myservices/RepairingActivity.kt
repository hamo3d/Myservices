...
import com.example.myservices.databinding.ActivityRepairingBinding
...
class RepairingActivity : AppCompatActivity(), ClickAction {

    private lateinit var binding: ActivityRepairingBinding
    private lateinit var adapter: DataSerViewAdapter
    private val services = ArrayList<Services>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRepairingBinding.inflate(layoutInflater)
    ...
    private fun setupRecyclerView() {
        adapter = DataSerViewAdapter(services, this@RepairingActivity)
        binding.rc.apply {
            adapter = this@RepairingActivity.adapter
            layoutManager = LinearLayoutManager(this@RepairingActivity)
        }
    }
    ...
    private fun loadData() {
        ...
        database.collection("services")
            .whereEqualTo("typeService", "repairing")
            .get()
    ...
    private fun createDatePickerDialog(): DatePickerDialog {
        return DatePickerDialog(this@RepairingActivity)
    }
