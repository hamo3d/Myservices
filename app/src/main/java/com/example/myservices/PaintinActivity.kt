...
import com.example.myservices.databinding.ActivityPaintinBinding
...
class PaintinActivity : AppCompatActivity(), ClickAction {

    private lateinit var binding: ActivityPaintinBinding
    private lateinit var adapter: DataSerViewAdapter
    private val services = ArrayList<Services>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPaintinBinding.inflate(layoutInflater)
    ...
    private fun setupRecyclerView() {
        adapter = DataSerViewAdapter(services, this@PaintinActivity)
        binding.rc.apply {
            adapter = this@PaintinActivity.adapter
            layoutManager = LinearLayoutManager(this@PaintinActivity)
        }
    }
    ...
    private fun loadData() {
        ...
        database.collection("services")
            .whereEqualTo("typeService", "painting")
            .get()
    ...
    private fun createDatePickerDialog(): DatePickerDialog {
        return DatePickerDialog(this@PaintinActivity)
    }
